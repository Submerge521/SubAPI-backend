...
import com.submerge.subapi.annotation.AuthCheck;
import com.submerge.subapi.common.*;
import com.submerge.subapi.constant.CommonConstant;
import com.submerge.subapi.exception.BusinessException;
import com.submerge.subapi.model.dto.interfaceinfo.*;
import com.submerge.subapi.model.enums.InterfacePublishEnum;
...
import com.submerge.subapiclientsdk.model.request.CurrencyRequest;
...
import static com.submerge.subapi.constant.UserConstant.ADMIN_ROLE;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> offLineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        interfaceInfo.setStatus(InterfacePublishEnum.OFFLINE.getValue());
        boolean result = interfaceInfoService.updateById(interfaceInfo);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Object> invokeInterface(@RequestBody InvokeRequest invokeRequest, HttpServletRequest request) {
        ...
        try {
            SubApiClient subApiClient = new SubApiClient(accessKey, secretKey);
            ...
            ResultResponse response = apiService.request(subApiClient, currencyRequest);
